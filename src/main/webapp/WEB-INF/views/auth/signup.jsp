...
<head>
    ...
    <link rel="stylesheet" href="/song/static/css/signup.css">
            ...
            <div class="content-box">
                <div class="item-box">
                    <div class="item-group">
                        ...
                        <form action="/song/auth/signup" method ="post">
                    ...
                    <div class="item-group">
                        <p>계정이 있으신가요? <a href="/song/auth/signin">로그인</a></p>
                    </div>
                    <div class="download-img">
                        <img src="/song/static/images/download.png">
                    </div>
                </div>
            </div>
        </main>
    </section>
    <script src="/song/static/js/signup.js"></script>
</body>
